    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <div class="sidebar-brand-text mx-2"><h5>Menentukan toko material terbaik daerah BSD </h5></div>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800 text-center">Selamat Datang di Halaman Dashboard!</h1><br>
        </div>
        <!-- /.container-fluid -->
