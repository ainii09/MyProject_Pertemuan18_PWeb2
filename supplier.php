        ...
        <?php
          ...
          switch($status):
            case 'sukses-baru':
              ...
              break;
            case 'sukses-hapus':
              $msg = 'Supplier behasil dihapus';
              break;
            case 'sukses-edit':
              $msg = 'Supplier behasil diedit';
              break;
          endswitch;
              ...
              <tbody>
                <?php while($hasil = $query->fetch()): ?>
                  <tr>
                    ...
                    <td><a href="edit-supplier.php?id=<?php echo $hasil['id_supplier']; ?>"><button class="btn btn-primary">Edit</button></a></td>
                    <td><a href="hapus-supplier.php?id=<?php echo $hasil['id_supplier']; ?>"><button class="btn btn-danger">Hapus</button></a></td>
                        ...
                        <td>
                          <td>
                            <td>
                              <td>
                                <td colspan="2">
                                    <td><a href="tambah-supplier.php"><button class="btn btn-success">Tambah</button></td>
                                </td>
                              </td>
                            </td>
                          </td>
